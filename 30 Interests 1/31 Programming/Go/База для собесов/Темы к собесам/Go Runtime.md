...
Аллокатор памяти в Go отвечает за выделение и управление [[Obsidian Sync/30 Interests 1/31 Programming/Go/База для собесов/Темы к собесам/Память в Go|памятью]] для объектов во время выполнения программы.
...
## **[[Obsidian Sync/30 Interests 1/31 Programming/Go/База для собесов/Темы к собесам/Сборщик мусора (GC)|Сборщик мусора]] (Garbage Collector, GC)**
...
## **[[Obsidian Sync/30 Interests 1/31 Programming/Go/База для собесов/Темы к собесам/Планировщик|Планировщик]] (Scheduler)**
...
## **[[Obsidian Sync/30 Interests 1/31 Programming/Go/База для собесов/Темы к собесам/Каналы|Каналы]] и их реализация**
