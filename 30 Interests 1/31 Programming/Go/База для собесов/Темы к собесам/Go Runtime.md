...
Аллокатор памяти в Go отвечает за выделение и управление [[30 Interests/31 Programming/Go/База для собесов/Темы к собесам/Память в Go|памятью]] для объектов во время выполнения программы.
...
## **[[30 Interests/31 Programming/Go/База для собесов/Темы к собесам/Сборщик мусора (GC)|Сборщик мусора]] (Garbage Collector, GC)**
...
## **[[30 Interests/31 Programming/Go/База для собесов/Темы к собесам/Планировщик|Планировщик]] (Scheduler)**
