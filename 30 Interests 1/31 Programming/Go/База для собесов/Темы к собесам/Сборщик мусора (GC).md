...
**Garbage Collector (GC)** — автоматический механизм управления памятью, встроенный в [[Obsidian Sync/30 Interests 1/31 Programming/Go/База для собесов/Темы к собесам/Go Runtime]]. Отслеживает объекты в [[Obsidian Sync/30 Interests 1/31 Programming/Go/База для собесов/Темы к собесам/Память в Go#**Куча (Heap) - медленнее стека**|куче]] и освобождает память от неиспользуемых.
...
- [[Obsidian Sync/30 Interests 1/31 Programming/Go/База для собесов/Темы к собесам/Память в Go]] — устройство аллокатора.
