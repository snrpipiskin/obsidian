...
**Garbage Collector (GC)** — автоматический механизм управления памятью, встроенный в [[30 Interests/31 Programming/Go/База для собесов/Темы к собесам/Go Runtime]]. Отслеживает объекты в [[30 Interests/31 Programming/Go/База для собесов/Темы к собесам/Память в Go#**Куча (Heap) - медленнее стека**|куче]] и освобождает память от неиспользуемых.
...
- [[30 Interests/31 Programming/Go/База для собесов/Темы к собесам/Память в Go]] — устройство аллокатора.
